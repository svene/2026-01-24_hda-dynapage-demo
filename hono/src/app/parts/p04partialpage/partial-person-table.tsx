...
import {partialPersonActionUrls} from "./partial-person-page-routing";
import {PersonTableModel} from "../../../generated/types/vm-types";

export const PartialPersonTable = (props: { vm: PersonTableModel }) => (
	<div id="result-table">
		<table class="table">
			<thead>
			<tr>
				<td colSpan={5}>
					<form
						id="bulkDeleteForm"
						hx-delete={partialPersonActionUrls.Delete.url()}
			...
			<tbody>
			{props.vm.people.map((it) => (<PartialPersonRow vm={it}/>))}
			</tbody>
		</table>
