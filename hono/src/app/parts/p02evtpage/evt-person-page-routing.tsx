...
const nameIdUrl = (name: JTSEvtPersonRouteName, id: number) => `/demo/event/uiroute/${name}?id=${id}`; // SPRING-HONO
const nameUrl = (name: JTSEvtPersonRouteName) => `/demo/event/uiroute/${name}`; // SPRING-HONO
